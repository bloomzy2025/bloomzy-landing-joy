      ...
      <div className="container mx-auto px-4 py-12 max-w-3xl">
        <Card className="w-full dark:bg-gray-800 dark:border-gray-700">
          <CardHeader className="text-center">
            ...
            <CardTitle className="text-3xl mb-2 dark:text-gray-100">{result.title}</CardTitle>
          ...
          <CardFooter className="flex justify-between">
            ...
            <Button onClick={() => navigate("/")} className="dark:bg-accent-green dark:text-gray-900 dark:hover:bg-accent-green/90">
              Return Home
            </Button>
          </CardFooter>
        </Card>
      ...
      <Card className="w-full dark:bg-gray-800 dark:border-gray-700">
        <CardHeader>
          <div className="flex items-center justify-between mb-2">
            <div className="flex items-center">
              <Wrench className="h-5 w-5 mr-2 text-blue-500 dark:text-blue-400" />
          ...
          <CardTitle className="text-2xl mb-2 dark:text-gray-100">{currentQuestion.text}</CardTitle>
          <div className="w-full bg-gray-200 rounded-full h-2.5 dark:bg-gray-700">
            <div className="bg-blue-500 h-2.5 rounded-full dark:bg-blue-400" style={{ width: `${currentProgress}%` }}></div>
          </div>
        </CardHeader>
        <CardContent>
          <RadioGroup 
          ...
          >
            {currentQuestion.options.map((option) => (
              <div key={option.id} className="flex items-center space-x-2 p-3 rounded-md hover:bg-gray-50 dark:hover:bg-gray-700">
        ...
        <CardFooter className="flex justify-between">
          ...
          <Button 
            ...
            className="gap-2 dark:bg-accent-green dark:text-gray-900 dark:hover:bg-accent-green/90"
          >
