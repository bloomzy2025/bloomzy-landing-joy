...
export default function Waitlist() {
  ...
  return <div className="relative min-h-screen">
      ...
      <div className="relative z-10 flex items-center justify-center min-h-screen">
        <div className="w-full max-w-3xl mx-auto px-4 sm:px-8 space-y-8 sm:space-y-12 pt-24 sm:pt-100 py-[86px]">
          ...
          <div className={`flex ${isMobile ? 'flex-col space-y-3' : 'flex-row gap-2'} max-w-md mx-auto`}>
            <Input type="email" placeholder="Enter your email" className="h-12 bg-gray-900/50 border-gray-700 text-white" />
            <Button size={isMobile ? "default" : "lg"} className="flex items-center gap-2 bg-brand-green hover:bg-brand-green/90 dark:bg-[#82c29e] dark:hover:bg-[#82c29e]/90 text-white">
              Get Notified
