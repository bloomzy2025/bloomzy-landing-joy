...
export default function SignInForm({ returnTo = '/' }: SignInFormProps) {
  ...
  const handleGoogleSignIn = () => {
    console.log('Manual Google sign-in initiated');
    try {
      signInWithProvider('google', returnTo);
    } catch (error) {
      console.error('Error initiating Google sign-in:', error);
      setGoogleError('Error initiating Google sign-in. Please try the email option.');
    }
  };
  
  const handleAppleSignIn = () => {
    console.log('Manual Apple sign-in initiated');
    try {
      signInWithProvider('apple', returnTo);
    } catch (error) {
      console.error('Error initiating Apple sign-in:', error);
      setAppleError('Error initiating Apple sign-in. Please try the email option.');
    }
  };
