...
const Feature = ({
  ...
  return (
    <div
      className={cn(
        "flex flex-col lg:border-r py-6 relative group/feature dark:border-gray-600",
    ...
    >
      ...
      <div className="mb-3 relative z-10 px-6 text-neutral-600 dark:text-neutral-200">
        {icon}
      </div>
      ...
      <p className="text-sm text-neutral-600 dark:text-neutral-200 max-w-xs relative z-10 px-6">
        {description}
      </p>
    </div>
  );
